...
class GaussianDiffusion:
    def __init__(self, net, betas, time_scale=1):
        super().__init__()
        self.net_ = net
    ...
    def p_sample(self, x, t, extra_args, eta=0, clip_denoised=True, clip_value=3):
    ...
    def p_sample_master(self, x, t, extra_args, eta=0, clip_denoised=True, clip_value=3):
        v = self.inference(x.float(), t, extra_args)
        alpha, sigma = self.get_alpha_sigma(x, t)
        pred = (x * alpha - v * sigma)
        if clip_denoised:
